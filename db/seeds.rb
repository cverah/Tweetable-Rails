...
cmvh = User.new(email: "cverah@gmail.com", username: "@cmvh", name: "Cristhian Vera", password: "admin123", role: "admin")
...
puts "Create tweets"
tweet_tanos = Tweet.new(body: "This universe is finite, its resources, finite… if life is left unchecked, life will cease to exist.", user: tanus)
tweet_tanos.save
